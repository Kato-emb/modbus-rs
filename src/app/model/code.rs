...
mod tests {
    ...
    fn test_model_code_function_code_from() {
        ...
        assert_eq!(
            FunctionCode::from(0x11),
            FunctionCode::Public(PublicFunctionCode::ReportServerId)
        );
        assert_eq!(
            FunctionCode::from(0x14),
            FunctionCode::Public(PublicFunctionCode::ReadFileRecord)
        );
        assert_eq!(
            FunctionCode::from(0x15),
            FunctionCode::Public(PublicFunctionCode::WriteFileRecord)
        );
        assert_eq!(
            FunctionCode::from(0x16),
            FunctionCode::Public(PublicFunctionCode::MaskWriteRegister)
        );
        assert_eq!(
            FunctionCode::from(0x17),
            FunctionCode::Public(PublicFunctionCode::ReadWriteMultipleRegisters)
        );
        assert_eq!(
            FunctionCode::from(0x18),
            FunctionCode::Public(PublicFunctionCode::ReadFifoQueue)
        );
        assert_eq!(
            FunctionCode::from(0x2B),
